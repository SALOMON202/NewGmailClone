...
<div class="rightbar" class:grande={!dxPiccolo} class:piccoloBack={dxPiccolo}>
  <div class="first-part"> 
    <div class="cont one"class:piccola={dxPiccolo}>
      <div class=" right calendario" ></div>
          <div class="black-box ">
      <nobr> Calendario</nobr>
    </div>
    </div>
    <div class="cont two" class:piccola={dxPiccolo}>
      <div class=" right keep"></div>
      <div class="black-box ">
        <nobr> Keep</nobr>
      </div>
    </div>
    <div class="cont three">
      <div class=" right tasks" class:piccola={dxPiccolo}></div>
      <div class="black-box ">
        <nobr> Tasks</nobr>
      </div>
    </div>
    <div class="cont four" class:piccola={dxPiccolo}>
      <div class=" right contatti" ></div>
      <div class="black-box ">
        <nobr> Contatti</nobr>
      </div>
    </div>
...
<div class="cont six"class:solido={ruota}  class:ruota ={ruota} on:click={chiudiDX}>
