...
{#each chiavi as chiave}
	{#if !chiave.includes('speciale') && !chiave.includes('risposta')}
		<div
			id="email--container"
			class:invisible={JSON.parse(localStorage.getItem(`${chiave}`))[0].includes(valore) ? false : true}
			class:toggled={value == chiave ? toggleEmail : console.log('nono')}
			on:mouseenter={() => {
		...
		>
			<div class="primi-due">
				<div class="checkbox" on:click={emailSelected} />
				<div class="star" class:selected={select} on:click={value == chiave ? favourites : console.log('ciao')} />
			</div>
			<div class="prima-pt">
				...
				<div class="email-text">
					<nobr>
						<div class="scritte">
							...
							<p class="dopo">
								<span class="different-color">{JSON.parse(localStorage.getItem(`${chiave}`))[1]}</span> - {JSON.parse(
			...
			>
				<nobr
					><span class="dob" class:showin={value == chiave ? toggleEmail : console.log('nono')}
						>{JSON.parse(localStorage.getItem(`${chiave}`))[4]}</span
					></nobr
				>
				<div class="toggled-content">
					<div class="first oo" class:showing={value == chiave ? toggleEmail : console.log('nono')}>
						<div class="first-img w" />
						<div class="black-box">
							<nobr>Archivia</nobr>
						</div>
					</div>
					<div class="second oo" class:showing={value == chiave ? toggleEmail : console.log('nono')}>
					...
					<div class="third oo" class:showing={value == chiave ? toggleEmail : console.log('nono')}>
					...
					<div class="fourth oo" class:showing={value == chiave ? toggleEmail : console.log('nono')}>
			...
			<div class="right-Space-shrunk">
				<span class="dobo" class:invisibile={value == chiave ? toggleEmail : console.log('nono')}
					>{JSON.parse(localStorage.getItem(`${chiave}`))[4]}</span
				>
			</div>
		</div>
	{:else if chiave.includes('risposta') && !chiave.includes('secondaparte')}
		<div
			id="email--container"
			class:toggled={chiave == `risposta${value}` ? toggleEmail : console.log('nono')}
			on:mouseenter={() => {
		...
		>
			<div class="primi-due">
				...
				<div
					...
					on:click={chiave == `risposta${value}` ? favourites : console.log('ciao')}
				/>
			</div>
			<div class="prima-pt">
				...
				<div class="email-text">
					<nobr>
						<div class="scritte">
							<div class="posta-in-arrivo">Posta in Arrivo</div>
							<p class="dopo">
								<span class="different-color"> Utente {JSON.parse(localStorage.getItem(`${chiave}`))[5]}</span> - {JSON.parse(
									localStorage.getItem(`${chiave}`)
								)[1]}
							</p>
						</div></nobr
			...
			>
				<nobr
					><span class="dob" class:showin={chiave == `risposta${value}` ? toggleEmail : console.log('nono')}
						>{JSON.parse(localStorage.getItem(`${chiave}`))[3]}</span
					></nobr
				>
				<div class="toggled-content">
					<div class="first oo" class:showing={chiave == `risposta${value}` ? toggleEmail : console.log('nono')}>
						<div class="first-img w" />
						<div class="black-box">
							<nobr>Archivia</nobr>
						</div>
					</div>
					<div class="second oo" class:showing={chiave == `risposta${value}` ? toggleEmail : console.log('nono')}>
						<div class="second-img w">
							<div class="black-box">
								<nobr>Elimina</nobr>
							</div>
					...
					<div class="third oo" class:showing={chiave == `risposta${value}` ? toggleEmail : console.log('nono')}>
						<div class="third-img w">
							<div class="black-box">
								<nobr>Segna come da leggere</nobr>
							</div>
					...
					<div class="fourth oo" class:showing={chiave == `risposta${value}` ? toggleEmail : console.log('nono')}>
						<div class="fourth-img w">
							<div class="black-box">
								<nobr>Posticipa</nobr>
							</div>
			...
			<div class="right-Space-shrunk">
				<span class="dobo" class:invisibile={chiave == `risposta${value}` ? toggleEmail : console.log('nono')}
					>{JSON.parse(localStorage.getItem(`${chiave}`))[3]}</span
				>
			</div>
		</div>
