...
export let surnameo
export let cityo
export let phonenumbero 
export let stateo
export let titleo
export let loginUUIDo 
export let pictureo
export let usernameo
export let oreo
export let minutio
export let emailo


const tornareIndietro = () => {
  let apriGrande = false ;
  dispatch('tornareIndietroo', apriGrande)
}
  ...
  <div class="email-big-header">
    <div class="icons">
      <div class="icon-popup">
        <div class=" icon first" on:click={tornareIndietro}></div></div>
      <div class=" st-group">
        <div class="icon-popup">
...
<img src={pictureo} alt="d" class='thumbnail-picture'>
</div>
<div class="title"><span class='user'><nobr>{usernameo} </nobr></span><span class='email'>{emailo}</span></div>

</div>

<div class="email-body">
  <div class="email-content">
  <p>Salve, sono {titleo} {nameo} {surnameo} e vorrei collaborare con voi. Vivo a {cityo}, in {stateo} ma sono disponibile anche a lavoro da remoto.
    Chiamate pure al numero {phonenumbero}</p>
