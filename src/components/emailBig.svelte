<script>
	...
	const attivaToggleFooter = () => {
		toggleFooter = true;
	};

	const disattivaToggleFooter = () => {
		toggleFooter = false;
	};
	...
	<div class="email-big-header">
		<div class="icons">
			<div class="icon-popup">
				<div class=" icon first" on:click={tornaIndietro} />
			</div>
			<div class=" st-group">
				<div class="icon-popup">
		...
		<div class="email-big-body">
			<div class="email-big-primo-titolo">
				...
				<div class="right">
					<div class=" wrap wart "><div class="firsto" /></div>
					<div class=" wrap wart"><div class="secondo" /></div>
					<div class="right-header">
						...
						<div class="right-right-header">
							<div class="wrap">
								<div
									class=" w "
									on:click={selezionaEaggiungiPreferiti}
									class:star={!selezionata}
									class:starselected={selezionata}
								/>
							</div>
							<div class="wrap"><div class="w freccia-indietro" /></div>
							<div class="wrap"><div class="w puntini" /></div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="email-body">
				<div class="email-content">
					<p>
						Salve, sono {title}
						{name}
						{surname} e vorrei collaborare con voi. Vivo a {city}, in {state} ma sono disponibile anche a lavoro da remoto.
						Chiamate pure al numero {phoneNumber}
					</p>
				</div>
				<div class="rispondi-darkspace"><div class="rispondi-whitespace" /></div>
				<footer>
							...
							<form on:submit|preventDefault={passaDatiAdInviati}>
								<div class="rispondi-header">
									<div class="rispondi-header-sinistra">
										<div class="rispondi img" />
										<span class="mail-username">A</span><input
											type="text"
											name="rispondi"
											id="rispondi-input"
											value={username}
										...
										<div class="rispondi-last-img" />
									</div>
									<div class="rispondi-header-destra" />
								</div>

								<div class="rispondi-last-part" />
								<textarea name="rispondi" id="rispondi-text" cols="100" rows="6" />
								...
								<div class="container">
									...
									<div class=" delete" on:click={disattivaToggleFooter}>
...
<style>
	...
	.rispondi-darkspace .right-header span {
		text-align: center;
	}
