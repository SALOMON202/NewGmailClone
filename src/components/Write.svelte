...
<div class='write' class:bigger = {bigger}  class:minimized = {
      minimize
    }
    class:ok={!minimize}>
  ...
  <div class="write-header" class:write-bigger = {bigger} class:align-correct = {bigger}>
   ...
   <div class="write-side" class:side-write ={bigger}>
    <div class="minimize opt" on:click={minimizer} class:min-bigger = {bigger}>
      ...
      <div class="expand opt" class:exp-bigger = {bigger}   on:click={
        expanding
      } >
        <div class="black-box">
          <nobr>{schermo}</nobr>
  ...
  <form on:submit|preventDefault={putInStorage} on:submit|preventDefault={addToArray} class:annullato ={minimize} class:ok={!minimize}>
    <div class="inputs" class:biggerspace={bigger}>
      <input type='text' placeholder={placeholder} class='input-pair first'id='dest' on:focus={changerPlace} on:blur={placeChanger} class:st-bigger ={bigger}>
      <input type='text' placeholder="Oggetto" class='input-pair second' id='obj'class:nd-bigger ={bigger}>
      <textarea type='text'class='input-pair big' id='mex'class:rd-bigger ={bigger}></textarea>
    </div>
  ...
  <div class="bottom-write-area" >
      ...
      <div class=" delete" class:bigger-delete = {
        bigger
      }>      <div class="black-box">
